...
build-sample-ios:
	(cd sample/ACP*Sample/ios && xcodebuild build -project ACPAnalyticsSample.xcodeproj -scheme ACPAnalyticsSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
